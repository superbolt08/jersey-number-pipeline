...
proposal = {
    ...
    'crop_width_scale': 1.15,  # horizontal torso crop scale; try 1.15 / 1.30 to include wider jersey context ( will try after running letterbox pad first)
    'str_letterbox_pad': False,  # preserve crop aspect ratio by black padding before PARSeq resize
}
