...
def analyze(pred_path, gt_path, top_k):
    ...
    print("")
    print(f"Sample first {min(20, len(errors))} error tracklets:")
    for track_id, g, p in errors[:20]:
        print(f"{track_id}: GT={g}, Pred={p}")
...
if __name__ == "__main__":
    ...
    analyze(args.pred, args.gt, args.top_k)
